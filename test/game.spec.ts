...
describe("Ways to create Game", () => {
    ...
    it('Title w/ Team Objects', () => {
        ...
        const result = new Game({name: "Test 2", token: "atoken", teams: teams});
    ...
    it('Build from JSON', () => {
        ...
        expect(result.teams.length, 'Teams did not import correctly.').equals(content.teams.length);
        expect(result.questions.length, 'Questions did not import correctly.').equals(content.questions.length);
